...
#cmt_local_tagfile = $(HIPileupTool_tag).make
cmt_local_tagfile = $(bin)$(HIPileupTool_tag).make
...
HIPileupTool_extratags = -tag_add=target_HIPileupTool
...
not_HIPileupTool_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupTool_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupTooldirs :
	@if test ! -d $(bin)HIPileupTool; then $(mkdir) -p $(bin)HIPileupTool; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupTool
else
HIPileupTooldirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupTool_makefile) : $(HIPileupTool_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_makefile) HIPileupTool
else
$(cmt_local_HIPileupTool_makefile) : $(HIPileupTool_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool) ] || \
	  $(not_HIPileupTool_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupTool.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_makefile) HIPileupTool; \
	  fi
endif
...
$(cmt_local_HIPileupTool_makefile) : $(HIPileupTool_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool.make"; \
	  $(cmtexe) -f=$(bin)HIPileupTool.in -tag=$(tags) $(HIPileupTool_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupTool_makefile) HIPileupTool
else
$(cmt_local_HIPileupTool_makefile) : $(HIPileupTool_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupTool.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool) ] || \
	  $(not_HIPileupTool_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupTool_extratags) build constituent_makefile -out=$(cmt_local_HIPileupTool_makefile) HIPileupTool

HIPileupTool :: $(HIPileupTool_dependencies) $(cmt_local_HIPileupTool_makefile) dirs HIPileupTooldirs
	$(echo) "(constituents.make) Starting HIPileupTool"
	@if test -f $(cmt_local_HIPileupTool_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_makefile) HIPileupTool; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_makefile) HIPileupTool
	$(echo) "(constituents.make) HIPileupTool done"

clean :: HIPileupToolclean ;

HIPileupToolclean :: $(HIPileupToolclean_dependencies) ##$(cmt_local_HIPileupTool_makefile)
	$(echo) "(constituents.make) Starting HIPileupToolclean"
	@-if test -f $(cmt_local_HIPileupTool_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_makefile) HIPileupToolclean; \
	fi
	$(echo) "(constituents.make) HIPileupToolclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_makefile) HIPileupToolclean

##	  /bin/rm -f $(cmt_local_HIPileupTool_makefile) $(bin)HIPileupTool_dependencies.make

install :: HIPileupToolinstall ;

HIPileupToolinstall :: $(HIPileupTool_dependencies) $(cmt_local_HIPileupTool_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupTool_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_makefile) install
...
$(foreach d,$(HIPileupTool_dependencies),$(eval $(d)uninstall_dependencies += HIPileupTooluninstall))

HIPileupTooluninstall : $(HIPileupTooluninstall_dependencies) ##$(cmt_local_HIPileupTool_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupTool_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupTooluninstall ;
...
HIPileupToolConf_extratags = -tag_add=target_HIPileupToolConf
...
not_HIPileupToolConf_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupToolConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupToolConfdirs :
	@if test ! -d $(bin)HIPileupToolConf; then $(mkdir) -p $(bin)HIPileupToolConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupToolConf
else
HIPileupToolConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupToolConf_makefile) : $(HIPileupToolConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolConf.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolConf_extratags) build constituent_config -out=$(cmt_local_HIPileupToolConf_makefile) HIPileupToolConf
else
$(cmt_local_HIPileupToolConf_makefile) : $(HIPileupToolConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolConf) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolConf) ] || \
	  $(not_HIPileupToolConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupToolConf.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolConf_extratags) build constituent_config -out=$(cmt_local_HIPileupToolConf_makefile) HIPileupToolConf; \
	  fi
endif
...
$(cmt_local_HIPileupToolConf_makefile) : $(HIPileupToolConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolConf.make"; \
	  $(cmtexe) -f=$(bin)HIPileupToolConf.in -tag=$(tags) $(HIPileupToolConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupToolConf_makefile) HIPileupToolConf
else
$(cmt_local_HIPileupToolConf_makefile) : $(HIPileupToolConf_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupToolConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolConf) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolConf) ] || \
	  $(not_HIPileupToolConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupToolConf_extratags) build constituent_makefile -out=$(cmt_local_HIPileupToolConf_makefile) HIPileupToolConf

HIPileupToolConf :: $(HIPileupToolConf_dependencies) $(cmt_local_HIPileupToolConf_makefile) dirs HIPileupToolConfdirs
	$(echo) "(constituents.make) Starting HIPileupToolConf"
	@if test -f $(cmt_local_HIPileupToolConf_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) HIPileupToolConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) HIPileupToolConf
	$(echo) "(constituents.make) HIPileupToolConf done"

clean :: HIPileupToolConfclean ;

HIPileupToolConfclean :: $(HIPileupToolConfclean_dependencies) ##$(cmt_local_HIPileupToolConf_makefile)
	$(echo) "(constituents.make) Starting HIPileupToolConfclean"
	@-if test -f $(cmt_local_HIPileupToolConf_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) HIPileupToolConfclean; \
	fi
	$(echo) "(constituents.make) HIPileupToolConfclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) HIPileupToolConfclean

##	  /bin/rm -f $(cmt_local_HIPileupToolConf_makefile) $(bin)HIPileupToolConf_dependencies.make

install :: HIPileupToolConfinstall ;

HIPileupToolConfinstall :: $(HIPileupToolConf_dependencies) $(cmt_local_HIPileupToolConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupToolConf_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(HIPileupToolConf_dependencies),$(eval $(d)uninstall_dependencies += HIPileupToolConfuninstall))

HIPileupToolConfuninstall : $(HIPileupToolConfuninstall_dependencies) ##$(cmt_local_HIPileupToolConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupToolConf_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupToolConfuninstall ;
...
HIPileupTool_python_init_extratags = -tag_add=target_HIPileupTool_python_init
...
not_HIPileupTool_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupTool_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupTool_python_initdirs :
	@if test ! -d $(bin)HIPileupTool_python_init; then $(mkdir) -p $(bin)HIPileupTool_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupTool_python_init
else
HIPileupTool_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupTool_python_init_makefile) : $(HIPileupTool_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_python_init_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_init
else
$(cmt_local_HIPileupTool_python_init_makefile) : $(HIPileupTool_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool_python_init) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool_python_init) ] || \
	  $(not_HIPileupTool_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupTool_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_python_init_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_init; \
	  fi
endif
...
$(cmt_local_HIPileupTool_python_init_makefile) : $(HIPileupTool_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool_python_init.make"; \
	  $(cmtexe) -f=$(bin)HIPileupTool_python_init.in -tag=$(tags) $(HIPileupTool_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_init
else
$(cmt_local_HIPileupTool_python_init_makefile) : $(HIPileupTool_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupTool_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool_python_init) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool_python_init) ] || \
	  $(not_HIPileupTool_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupTool_python_init_extratags) build constituent_makefile -out=$(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_init

HIPileupTool_python_init :: $(HIPileupTool_python_init_dependencies) $(cmt_local_HIPileupTool_python_init_makefile) dirs HIPileupTool_python_initdirs
	$(echo) "(constituents.make) Starting HIPileupTool_python_init"
	@if test -f $(cmt_local_HIPileupTool_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_init
	$(echo) "(constituents.make) HIPileupTool_python_init done"

clean :: HIPileupTool_python_initclean ;

HIPileupTool_python_initclean :: $(HIPileupTool_python_initclean_dependencies) ##$(cmt_local_HIPileupTool_python_init_makefile)
	$(echo) "(constituents.make) Starting HIPileupTool_python_initclean"
	@-if test -f $(cmt_local_HIPileupTool_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_initclean; \
	fi
	$(echo) "(constituents.make) HIPileupTool_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) HIPileupTool_python_initclean

##	  /bin/rm -f $(cmt_local_HIPileupTool_python_init_makefile) $(bin)HIPileupTool_python_init_dependencies.make

install :: HIPileupTool_python_initinstall ;

HIPileupTool_python_initinstall :: $(HIPileupTool_python_init_dependencies) $(cmt_local_HIPileupTool_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupTool_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(HIPileupTool_python_init_dependencies),$(eval $(d)uninstall_dependencies += HIPileupTool_python_inituninstall))

HIPileupTool_python_inituninstall : $(HIPileupTool_python_inituninstall_dependencies) ##$(cmt_local_HIPileupTool_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupTool_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupTool_python_inituninstall ;
...
HIPileupToolConfDbMerge_extratags = -tag_add=target_HIPileupToolConfDbMerge
...
not_HIPileupToolConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupToolConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupToolConfDbMergedirs :
	@if test ! -d $(bin)HIPileupToolConfDbMerge; then $(mkdir) -p $(bin)HIPileupToolConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupToolConfDbMerge
else
HIPileupToolConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupToolConfDbMerge_makefile) : $(HIPileupToolConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolConfDbMerge_extratags) build constituent_config -out=$(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMerge
else
$(cmt_local_HIPileupToolConfDbMerge_makefile) : $(HIPileupToolConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolConfDbMerge) ] || \
	  $(not_HIPileupToolConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupToolConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolConfDbMerge_extratags) build constituent_config -out=$(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMerge; \
	  fi
endif
...
$(cmt_local_HIPileupToolConfDbMerge_makefile) : $(HIPileupToolConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)HIPileupToolConfDbMerge.in -tag=$(tags) $(HIPileupToolConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMerge
else
$(cmt_local_HIPileupToolConfDbMerge_makefile) : $(HIPileupToolConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupToolConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolConfDbMerge) ] || \
	  $(not_HIPileupToolConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupToolConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMerge

HIPileupToolConfDbMerge :: $(HIPileupToolConfDbMerge_dependencies) $(cmt_local_HIPileupToolConfDbMerge_makefile) dirs HIPileupToolConfDbMergedirs
	$(echo) "(constituents.make) Starting HIPileupToolConfDbMerge"
	@if test -f $(cmt_local_HIPileupToolConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMerge
	$(echo) "(constituents.make) HIPileupToolConfDbMerge done"

clean :: HIPileupToolConfDbMergeclean ;

HIPileupToolConfDbMergeclean :: $(HIPileupToolConfDbMergeclean_dependencies) ##$(cmt_local_HIPileupToolConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting HIPileupToolConfDbMergeclean"
	@-if test -f $(cmt_local_HIPileupToolConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) HIPileupToolConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) HIPileupToolConfDbMergeclean

##	  /bin/rm -f $(cmt_local_HIPileupToolConfDbMerge_makefile) $(bin)HIPileupToolConfDbMerge_dependencies.make

install :: HIPileupToolConfDbMergeinstall ;

HIPileupToolConfDbMergeinstall :: $(HIPileupToolConfDbMerge_dependencies) $(cmt_local_HIPileupToolConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupToolConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : HIPileupToolConfDbMergeuninstall

$(foreach d,$(HIPileupToolConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += HIPileupToolConfDbMergeuninstall))

HIPileupToolConfDbMergeuninstall : $(HIPileupToolConfDbMergeuninstall_dependencies) ##$(cmt_local_HIPileupToolConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupToolConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupToolConfDbMergeuninstall ;
...
HIPileupToolComponentsList_extratags = -tag_add=target_HIPileupToolComponentsList
...
not_HIPileupToolComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupToolComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupToolComponentsListdirs :
	@if test ! -d $(bin)HIPileupToolComponentsList; then $(mkdir) -p $(bin)HIPileupToolComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupToolComponentsList
else
HIPileupToolComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupToolComponentsList_makefile) : $(HIPileupToolComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolComponentsList_extratags) build constituent_config -out=$(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsList
else
$(cmt_local_HIPileupToolComponentsList_makefile) : $(HIPileupToolComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolComponentsList) ] || \
	  $(not_HIPileupToolComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupToolComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolComponentsList_extratags) build constituent_config -out=$(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsList; \
	  fi
endif
...
$(cmt_local_HIPileupToolComponentsList_makefile) : $(HIPileupToolComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolComponentsList.make"; \
	  $(cmtexe) -f=$(bin)HIPileupToolComponentsList.in -tag=$(tags) $(HIPileupToolComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsList
else
$(cmt_local_HIPileupToolComponentsList_makefile) : $(HIPileupToolComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupToolComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolComponentsList) ] || \
	  $(not_HIPileupToolComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupToolComponentsList_extratags) build constituent_makefile -out=$(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsList

HIPileupToolComponentsList :: $(HIPileupToolComponentsList_dependencies) $(cmt_local_HIPileupToolComponentsList_makefile) dirs HIPileupToolComponentsListdirs
	$(echo) "(constituents.make) Starting HIPileupToolComponentsList"
	@if test -f $(cmt_local_HIPileupToolComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsList
	$(echo) "(constituents.make) HIPileupToolComponentsList done"

clean :: HIPileupToolComponentsListclean ;

HIPileupToolComponentsListclean :: $(HIPileupToolComponentsListclean_dependencies) ##$(cmt_local_HIPileupToolComponentsList_makefile)
	$(echo) "(constituents.make) Starting HIPileupToolComponentsListclean"
	@-if test -f $(cmt_local_HIPileupToolComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsListclean; \
	fi
	$(echo) "(constituents.make) HIPileupToolComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) HIPileupToolComponentsListclean

##	  /bin/rm -f $(cmt_local_HIPileupToolComponentsList_makefile) $(bin)HIPileupToolComponentsList_dependencies.make

install :: HIPileupToolComponentsListinstall ;

HIPileupToolComponentsListinstall :: $(HIPileupToolComponentsList_dependencies) $(cmt_local_HIPileupToolComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupToolComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(HIPileupToolComponentsList_dependencies),$(eval $(d)uninstall_dependencies += HIPileupToolComponentsListuninstall))

HIPileupToolComponentsListuninstall : $(HIPileupToolComponentsListuninstall_dependencies) ##$(cmt_local_HIPileupToolComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupToolComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupToolComponentsListuninstall ;
...
HIPileupToolMergeComponentsList_extratags = -tag_add=target_HIPileupToolMergeComponentsList
...
not_HIPileupToolMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupToolMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupToolMergeComponentsListdirs :
	@if test ! -d $(bin)HIPileupToolMergeComponentsList; then $(mkdir) -p $(bin)HIPileupToolMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupToolMergeComponentsList
else
HIPileupToolMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupToolMergeComponentsList_makefile) : $(HIPileupToolMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsList
else
$(cmt_local_HIPileupToolMergeComponentsList_makefile) : $(HIPileupToolMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolMergeComponentsList) ] || \
	  $(not_HIPileupToolMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupToolMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsList; \
	  fi
endif
...
$(cmt_local_HIPileupToolMergeComponentsList_makefile) : $(HIPileupToolMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)HIPileupToolMergeComponentsList.in -tag=$(tags) $(HIPileupToolMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsList
else
$(cmt_local_HIPileupToolMergeComponentsList_makefile) : $(HIPileupToolMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupToolMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolMergeComponentsList) ] || \
	  $(not_HIPileupToolMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupToolMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsList

HIPileupToolMergeComponentsList :: $(HIPileupToolMergeComponentsList_dependencies) $(cmt_local_HIPileupToolMergeComponentsList_makefile) dirs HIPileupToolMergeComponentsListdirs
	$(echo) "(constituents.make) Starting HIPileupToolMergeComponentsList"
	@if test -f $(cmt_local_HIPileupToolMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsList
	$(echo) "(constituents.make) HIPileupToolMergeComponentsList done"

clean :: HIPileupToolMergeComponentsListclean ;

HIPileupToolMergeComponentsListclean :: $(HIPileupToolMergeComponentsListclean_dependencies) ##$(cmt_local_HIPileupToolMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting HIPileupToolMergeComponentsListclean"
	@-if test -f $(cmt_local_HIPileupToolMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) HIPileupToolMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) HIPileupToolMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) $(bin)HIPileupToolMergeComponentsList_dependencies.make

install :: HIPileupToolMergeComponentsListinstall ;

HIPileupToolMergeComponentsListinstall :: $(HIPileupToolMergeComponentsList_dependencies) $(cmt_local_HIPileupToolMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupToolMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : HIPileupToolMergeComponentsListuninstall

$(foreach d,$(HIPileupToolMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += HIPileupToolMergeComponentsListuninstall))

HIPileupToolMergeComponentsListuninstall : $(HIPileupToolMergeComponentsListuninstall_dependencies) ##$(cmt_local_HIPileupToolMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupToolMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupToolMergeComponentsListuninstall ;
...
HIPileupTool_optdebug_library_extratags = -tag_add=target_HIPileupTool_optdebug_library
...
not_HIPileupTool_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupTool_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupTool_optdebug_librarydirs :
	@if test ! -d $(bin)HIPileupTool_optdebug_library; then $(mkdir) -p $(bin)HIPileupTool_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupTool_optdebug_library
else
HIPileupTool_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupTool_optdebug_library_makefile) : $(HIPileupTool_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_optdebug_library_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_library
else
$(cmt_local_HIPileupTool_optdebug_library_makefile) : $(HIPileupTool_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool_optdebug_library) ] || \
	  $(not_HIPileupTool_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupTool_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_optdebug_library_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_library; \
	  fi
endif
...
$(cmt_local_HIPileupTool_optdebug_library_makefile) : $(HIPileupTool_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)HIPileupTool_optdebug_library.in -tag=$(tags) $(HIPileupTool_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_library
else
$(cmt_local_HIPileupTool_optdebug_library_makefile) : $(HIPileupTool_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupTool_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool_optdebug_library) ] || \
	  $(not_HIPileupTool_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupTool_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_library

HIPileupTool_optdebug_library :: $(HIPileupTool_optdebug_library_dependencies) $(cmt_local_HIPileupTool_optdebug_library_makefile) dirs HIPileupTool_optdebug_librarydirs
	$(echo) "(constituents.make) Starting HIPileupTool_optdebug_library"
	@if test -f $(cmt_local_HIPileupTool_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_library
	$(echo) "(constituents.make) HIPileupTool_optdebug_library done"

clean :: HIPileupTool_optdebug_libraryclean ;

HIPileupTool_optdebug_libraryclean :: $(HIPileupTool_optdebug_libraryclean_dependencies) ##$(cmt_local_HIPileupTool_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting HIPileupTool_optdebug_libraryclean"
	@-if test -f $(cmt_local_HIPileupTool_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) HIPileupTool_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) HIPileupTool_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_HIPileupTool_optdebug_library_makefile) $(bin)HIPileupTool_optdebug_library_dependencies.make

install :: HIPileupTool_optdebug_libraryinstall ;

HIPileupTool_optdebug_libraryinstall :: $(HIPileupTool_optdebug_library_dependencies) $(cmt_local_HIPileupTool_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupTool_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(HIPileupTool_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += HIPileupTool_optdebug_libraryuninstall))

HIPileupTool_optdebug_libraryuninstall : $(HIPileupTool_optdebug_libraryuninstall_dependencies) ##$(cmt_local_HIPileupTool_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupTool_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupTool_optdebug_libraryuninstall ;
...
HIPileupToolCLIDDB_extratags = -tag_add=target_HIPileupToolCLIDDB
...
not_HIPileupToolCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupToolCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupToolCLIDDBdirs :
	@if test ! -d $(bin)HIPileupToolCLIDDB; then $(mkdir) -p $(bin)HIPileupToolCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupToolCLIDDB
else
HIPileupToolCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupToolCLIDDB_makefile) : $(HIPileupToolCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolCLIDDB_extratags) build constituent_config -out=$(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDB
else
$(cmt_local_HIPileupToolCLIDDB_makefile) : $(HIPileupToolCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolCLIDDB) ] || \
	  $(not_HIPileupToolCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupToolCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolCLIDDB_extratags) build constituent_config -out=$(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDB; \
	  fi
endif
...
$(cmt_local_HIPileupToolCLIDDB_makefile) : $(HIPileupToolCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)HIPileupToolCLIDDB.in -tag=$(tags) $(HIPileupToolCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDB
else
$(cmt_local_HIPileupToolCLIDDB_makefile) : $(HIPileupToolCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupToolCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolCLIDDB) ] || \
	  $(not_HIPileupToolCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupToolCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDB

HIPileupToolCLIDDB :: $(HIPileupToolCLIDDB_dependencies) $(cmt_local_HIPileupToolCLIDDB_makefile) dirs HIPileupToolCLIDDBdirs
	$(echo) "(constituents.make) Starting HIPileupToolCLIDDB"
	@if test -f $(cmt_local_HIPileupToolCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDB
	$(echo) "(constituents.make) HIPileupToolCLIDDB done"

clean :: HIPileupToolCLIDDBclean ;

HIPileupToolCLIDDBclean :: $(HIPileupToolCLIDDBclean_dependencies) ##$(cmt_local_HIPileupToolCLIDDB_makefile)
	$(echo) "(constituents.make) Starting HIPileupToolCLIDDBclean"
	@-if test -f $(cmt_local_HIPileupToolCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDBclean; \
	fi
	$(echo) "(constituents.make) HIPileupToolCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) HIPileupToolCLIDDBclean

##	  /bin/rm -f $(cmt_local_HIPileupToolCLIDDB_makefile) $(bin)HIPileupToolCLIDDB_dependencies.make

install :: HIPileupToolCLIDDBinstall ;

HIPileupToolCLIDDBinstall :: $(HIPileupToolCLIDDB_dependencies) $(cmt_local_HIPileupToolCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupToolCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : HIPileupToolCLIDDBuninstall

$(foreach d,$(HIPileupToolCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += HIPileupToolCLIDDBuninstall))

HIPileupToolCLIDDBuninstall : $(HIPileupToolCLIDDBuninstall_dependencies) ##$(cmt_local_HIPileupToolCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupToolCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupToolCLIDDBuninstall ;
...
cmt_HIPileupToolrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_HIPileupToolrchk_has_target_tag

cmt_local_tagfile_HIPileupToolrchk = $(bin)$(HIPileupTool_tag)_HIPileupToolrchk.make
cmt_final_setup_HIPileupToolrchk = $(bin)setup_HIPileupToolrchk.make
cmt_local_HIPileupToolrchk_makefile = $(bin)HIPileupToolrchk.make

HIPileupToolrchk_extratags = -tag_add=target_HIPileupToolrchk

else

cmt_local_tagfile_HIPileupToolrchk = $(bin)$(HIPileupTool_tag).make
cmt_final_setup_HIPileupToolrchk = $(bin)setup.make
cmt_local_HIPileupToolrchk_makefile = $(bin)HIPileupToolrchk.make

endif

not_HIPileupToolrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupToolrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupToolrchkdirs :
	@if test ! -d $(bin)HIPileupToolrchk; then $(mkdir) -p $(bin)HIPileupToolrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupToolrchk
else
HIPileupToolrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupToolrchk_makefile) : $(HIPileupToolrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolrchk_extratags) build constituent_config -out=$(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchk
else
$(cmt_local_HIPileupToolrchk_makefile) : $(HIPileupToolrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolrchk) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolrchk) ] || \
	  $(not_HIPileupToolrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupToolrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupToolrchk_extratags) build constituent_config -out=$(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchk; \
	  fi
endif
...
$(cmt_local_HIPileupToolrchk_makefile) : $(HIPileupToolrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupToolrchk.make"; \
	  $(cmtexe) -f=$(bin)HIPileupToolrchk.in -tag=$(tags) $(HIPileupToolrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchk
else
$(cmt_local_HIPileupToolrchk_makefile) : $(HIPileupToolrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupToolrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupToolrchk) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupToolrchk) ] || \
	  $(not_HIPileupToolrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupToolrchk_extratags) build constituent_makefile -out=$(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchk

HIPileupToolrchk :: $(HIPileupToolrchk_dependencies) $(cmt_local_HIPileupToolrchk_makefile) dirs HIPileupToolrchkdirs
	$(echo) "(constituents.make) Starting HIPileupToolrchk"
	@if test -f $(cmt_local_HIPileupToolrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchk
	$(echo) "(constituents.make) HIPileupToolrchk done"

clean :: HIPileupToolrchkclean ;

HIPileupToolrchkclean :: $(HIPileupToolrchkclean_dependencies) ##$(cmt_local_HIPileupToolrchk_makefile)
	$(echo) "(constituents.make) Starting HIPileupToolrchkclean"
	@-if test -f $(cmt_local_HIPileupToolrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchkclean; \
	fi
	$(echo) "(constituents.make) HIPileupToolrchkclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) HIPileupToolrchkclean

##	  /bin/rm -f $(cmt_local_HIPileupToolrchk_makefile) $(bin)HIPileupToolrchk_dependencies.make

install :: HIPileupToolrchkinstall ;

HIPileupToolrchkinstall :: $(HIPileupToolrchk_dependencies) $(cmt_local_HIPileupToolrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupToolrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : HIPileupToolrchkuninstall

$(foreach d,$(HIPileupToolrchk_dependencies),$(eval $(d)uninstall_dependencies += HIPileupToolrchkuninstall))

HIPileupToolrchkuninstall : $(HIPileupToolrchkuninstall_dependencies) ##$(cmt_local_HIPileupToolrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupToolrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupToolrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupToolrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(HIPileupTool_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(HIPileupTool_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_make = $(bin)$(HIPileupTool_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(HIPileupTool_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(HIPileupTool_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(HIPileupTool_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(HIPileupTool_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(HIPileupTool_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(HIPileupTool_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(HIPileupTool_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(HIPileupTool_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(HIPileupTool_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(HIPileupTool_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(HIPileupTool_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(HIPileupTool_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(HIPileupTool_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(HIPileupTool_tag).make
...
cmt_HIPileupTool_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_HIPileupTool_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_HIPileupTool_NICOS_Fix_debuginfo = $(bin)$(HIPileupTool_tag)_HIPileupTool_NICOS_Fix_debuginfo.make
cmt_final_setup_HIPileupTool_NICOS_Fix_debuginfo = $(bin)setup_HIPileupTool_NICOS_Fix_debuginfo.make
cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile = $(bin)HIPileupTool_NICOS_Fix_debuginfo.make

HIPileupTool_NICOS_Fix_debuginfo_extratags = -tag_add=target_HIPileupTool_NICOS_Fix_debuginfo

else

cmt_local_tagfile_HIPileupTool_NICOS_Fix_debuginfo = $(bin)$(HIPileupTool_tag).make
cmt_final_setup_HIPileupTool_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile = $(bin)HIPileupTool_NICOS_Fix_debuginfo.make

endif

not_HIPileupTool_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(HIPileupTool_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
HIPileupTool_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)HIPileupTool_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)HIPileupTool_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)HIPileupTool_NICOS_Fix_debuginfo
else
HIPileupTool_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) : $(HIPileupTool_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfo
else
$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) : $(HIPileupTool_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool_NICOS_Fix_debuginfo) ] || \
	  $(not_HIPileupTool_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building HIPileupTool_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(HIPileupTool_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) : $(HIPileupTool_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building HIPileupTool_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)HIPileupTool_NICOS_Fix_debuginfo.in -tag=$(tags) $(HIPileupTool_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfo
else
$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) : $(HIPileupTool_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)HIPileupTool_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_HIPileupTool_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_HIPileupTool_NICOS_Fix_debuginfo) ] || \
	  $(not_HIPileupTool_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(HIPileupTool_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfo

HIPileupTool_NICOS_Fix_debuginfo :: $(HIPileupTool_NICOS_Fix_debuginfo_dependencies) $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) dirs HIPileupTool_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting HIPileupTool_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) HIPileupTool_NICOS_Fix_debuginfo done"

clean :: HIPileupTool_NICOS_Fix_debuginfoclean ;

HIPileupTool_NICOS_Fix_debuginfoclean :: $(HIPileupTool_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting HIPileupTool_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) HIPileupTool_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) HIPileupTool_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) $(bin)HIPileupTool_NICOS_Fix_debuginfo_dependencies.make

install :: HIPileupTool_NICOS_Fix_debuginfoinstall ;

HIPileupTool_NICOS_Fix_debuginfoinstall :: $(HIPileupTool_NICOS_Fix_debuginfo_dependencies) $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : HIPileupTool_NICOS_Fix_debuginfouninstall

$(foreach d,$(HIPileupTool_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += HIPileupTool_NICOS_Fix_debuginfouninstall))

HIPileupTool_NICOS_Fix_debuginfouninstall : $(HIPileupTool_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_HIPileupTool_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: HIPileupTool_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_find_packages = $(bin)$(HIPileupTool_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_compile = $(bin)$(HIPileupTool_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(HIPileupTool_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(HIPileupTool_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(HIPileupTool_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(HIPileupTool_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(HIPileupTool_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(HIPileupTool_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(HIPileupTool_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(HIPileupTool_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(HIPileupTool_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(HIPileupTool_tag).make

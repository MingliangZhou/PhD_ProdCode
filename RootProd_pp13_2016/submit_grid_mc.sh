prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.ND.Jun30.cumu.jetSubEvt \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.HMT120.Jun30.cumu.jetSubEvt \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.HMT160.Jun30.cumu.jetSubEvt \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.HMT200.Jun30.cumu.jetSubEvt \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore

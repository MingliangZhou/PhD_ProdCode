...
#jps.AthenaCommonFlags.FilesInput = ["/afs/cern.ch/work/m/mizhou/INPUT_test/data15_PbPb5_MinBias_287321_cutLv3.root"]   #insert your list of input files here (do this before next lines)
...
algseq += CfgMgr.XeXeCentAlg()                                 #adds an instance of your alg to it
...
#xaodStream.AddAcceptAlgs( "XeXeCentAlg" ) #will only keep events where 'setFilterPassed(false)' has NOT been called in the given algorithm

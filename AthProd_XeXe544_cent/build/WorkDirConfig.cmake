...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.2.5)" )
endif()
...
set( WorkDir_BASE_PROJECTS AthAnalysis;21.2.5 )
...
set( WorkDir_PACKAGE_NAMES XeXeCent )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES XeXeCentPkg;XeXeCentPkgPrivate;XeXeCentLib;XeXeCent )

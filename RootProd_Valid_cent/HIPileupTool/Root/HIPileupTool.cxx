...
StatusCode HIPileupTool::initialize() {
   ...
   else fullInpFilePath = gSystem->ExpandPathName ("$ROOTCOREBIN/data/HIPileupTool/HIRun2PileUp_PbPb5p02_v2.root");
...
/*bool HIPileupTool::is_pileup(const xAOD::HIEventShapeContainer& evShCont, double ZdcE) {
...
double HIPileupTool::get_nNeutrons(const xAOD::ZdcModuleContainer& ZdcCont) { 

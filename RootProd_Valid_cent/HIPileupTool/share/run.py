...
from HIPileupTool.HIPileupToolConf import HIPileupAlgo
job += HIPileupAlgo("halg")
halg = job.halg
...
if 1:
  from HIPileupTool.HIPileupToolConf import HIPileupTool
  ToolSvc += HIPileupTool("atool")
  atool = ToolSvc.atool

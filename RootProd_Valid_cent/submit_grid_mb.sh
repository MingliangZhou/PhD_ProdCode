prun \
    ...
    --outDS=user.mizhou.data15_hi.00286711.Mar23.CENT \
    --outputs=myaod.root \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.data15_hi.00286717.Mar23.CENT \
    --outputs=myaod.root \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.data15_hi.00286748.Mar23.CENT \
    --outputs=myaod.root \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.data15_hi.00287281.Mar23.CENT \
    --outputs=myaod.root \
    --useRootCore

...
EL::StatusCode MyxAODAnalysis :: initialize ()
{
	...
	tree = new TTree("tree","2016 pPb 8 TeV");
	...
	tree->Branch("FCalCosEtA",FCalCosEtA,"FCalCosEtA[7]/F");
	tree->Branch("FCalSinEtA",FCalSinEtA,"FCalSinEtA[7]/F");
	tree->Branch("FCalCosEtC",FCalCosEtC,"FCalCosEtC[7]/F");
	tree->Branch("FCalSinEtC",FCalSinEtC,"FCalSinEtC[7]/F");
	tree->Branch("ZdcEtA", 	 &ZdcEtA,   "ZdcEtA/F");
	tree->Branch("ZdcEtC", 	 &ZdcEtC,   "ZdcEtC/F");
	tree->Branch("nTrk", 		 &nTrk,     "nTrk/i");
	tree->Branch("trkInfo",  trkInfo,   "trkInfo[nTrk]/i");
	//tree->Branch("trkZ0",    trkZ0,     "trkZ0[nTrk]/F");
	//tree->Branch("trkD0",    trkD0,     "trkD0[nTrk]/F");
...
EL::StatusCode MyxAODAnalysis :: execute ()
{
	...
	if(1)
	{
		for(int i=0; i<33; i++)
		{
			if(i==0)  sprintf(name,"HLT_mb_sptrk_L1MBTS_1");
			if(i==1)  sprintf(name,"HLT_mb_sp2400_pusup500_trk120_hmt_L1TE20");
			if(i==2)  sprintf(name,"HLT_mb_sp2800_pusup600_trk140_hmt_L1TE20");
			if(i==3)  sprintf(name,"HLT_mb_sp2800_pusup600_trk140_hmt_L1TE50");
			if(i==4)  sprintf(name,"HLT_mb_sp3100_pusup700_trk160_hmt_L1TE50");
			if(i==5)  sprintf(name,"HLT_mb_sp3100_pusup700_trk160_hmt_L1TE70");
			if(i==6)  sprintf(name,"HLT_mb_sp3500_pusup800_trk180_hmt_L1TE70");
			if(i==7)  sprintf(name,"HLT_mb_sp3500_pusup800_trk180_hmt_L1TE90");
			if(i==8)  sprintf(name,"HLT_mb_sp4100_pusup900_trk200_hmt_L1TE90");
			if(i==9)  sprintf(name,"HLT_mb_sp4100_pusup900_trk200_hmt_L1TE120");
			if(i==10)  sprintf(name,"HLT_mb_sp4500_pusup1000_trk220_hmt_L1TE120");
			if(i==11)  sprintf(name,"HLT_mb_sp4800_pusup1100_trk240_hmt_L1TE160");
			if(i==12)  sprintf(name,"HLT_mb_sp5000_pusup1100_trk240_hmt_L1TE200");
			if(i==13)  sprintf(name,"HLT_mb_sp5000_pusup1200_trk260_hmt_L1TE160");
			if(i==14)  sprintf(name,"HLT_mb_sp5600_pusup1300_trk260_hmt_L1TE200");
			if(i==15)  sprintf(name,"HLT_mb_sp5200_pusup1300_trk280_hmt_L1TE160");
			if(i==16)  sprintf(name,"HLT_mb_sp6000_pusup1400_trk280_hmt_L1TE200");
			if(i==17)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp3100_pusup700_trk160_hmt_L1TE120");
			if(i==18)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp3100_pusup700_trk160_hmt_L1TE120");
			if(i==19)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp4100_pusup900_trk200_hmt_L1TE120");
			if(i==20)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp4100_pusup900_trk200_hmt_L1TE120");
			if(i==21)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp4800_pusup1100_trk240_hmt_L1TE120");
			if(i==22)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp4800_pusup1100_trk240_hmt_L1TE120");
			if(i==23)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp4100_pusup900_trk200_hmt_L1TE160");
			if(i==24)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp4100_pusup900_trk200_hmt_L1TE160");
			if(i==25)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp5000_pusup1200_trk260_hmt_L1TE160");
			if(i==26)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp5000_pusup1200_trk260_hmt_L1TE160");
			if(i==27)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp4100_pusup900_trk200_hmt_L1TE200");
			if(i==28)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp4100_pusup900_trk200_hmt_L1TE200");
			if(i==29)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp4500_pusup1000_trk220_hmt_L1TE200");
			if(i==30)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp4500_pusup1000_trk220_hmt_L1TE200");
			if(i==31)  sprintf(name,"HLT_hi_v2A_th05p_mb_sp4800_pusup1100_trk240_hmt_L1TE200");
			if(i==32)  sprintf(name,"HLT_hi_v2C_th05p_mb_sp4800_pusup1100_trk240_hmt_L1TE200");
	...
	for(const auto *ptrEvtShp : *ptrEvtShpCon)
	{
		if(ptrEvtShp->layer()==21 || ptrEvtShp->layer()==22 || ptrEvtShp->layer()==23)
		{
			...
			{
				FCalEtA += ptrEvtShp->et()/1e6;
				for(int i=0; i<7; i++)
				{
					FCalCosEtA[i] += (ptrEvtShp->etCos()).at(i)/1e6;
					FCalSinEtA[i] += (ptrEvtShp->etSin()).at(i)/1e6;
				}
			}
			if((ptrEvtShp->etaMin()+ptrEvtShp->etaMax())/2<0)
			{
				FCalEtC += ptrEvtShp->et()/1e6;
				for(int i=0; i<7; i++)
				{
					FCalCosEtC[i] += (ptrEvtShp->etCos()).at(i)/1e6;
					FCalSinEtC[i] += (ptrEvtShp->etSin()).at(i)/1e6;
				}
			}
		}
	}
	...
	{
		if(ptrZdc->type()!=0) continue;
		if(ptrZdc->side()==-1) ZdcEtA += ptrZdc->auxdataConst<float>("Amplitude");
		if(ptrZdc->side()==+1) ZdcEtC += ptrZdc->auxdataConst<float>("Amplitude");
	}
	...
	if(runNo>313435)
	{
		swap = FCalEtA; FCalEtA = FCalEtC; FCalEtC = swap;
		swap = ZdcEtA;  ZdcEtA = ZdcEtC;   ZdcEtC = swap;
	}
	
	//------------------------------------------------------  
	// Reconstructed Vertex
	//------------------------------------------------------ 
	for(int i=0; i<10; i++) zVtx[i] = 99999;
	nVtx = 0;
	...
	for(const auto ptrRecVtx : *ptrRecVtxCon)
	{
		if(!(ptrRecVtx->vertexType() == xAOD::VxType::PriVtx))
		{
			if(ptrRecVtx->nTrackParticles()>3 && nVtx<10)
			{
				zVtx[nVtx] = ptrRecVtx->z();
				nVtx ++;
			}
	...
	if(fabs(zVtx[0])>150) return EL::StatusCode::SUCCESS;
  ...
  const xAOD::Vertex *ptrVtx = 0;
	...
	{
		if(!trackSelection(ptrRecTrk, zVtx[0])) continue;
		ptrVtx = vertexParticle(ptrRecTrk);
		if(!ptrVtx) continue;
		else if(fabs(ptrVtx->z()-zVtx[0])>0.0001) continue;

		if(ptrRecTrk->charge()>0) trkChg = 1;
		else if(ptrRecTrk->charge()<0) trkChg = 0;
		if(fabs(sin(ptrRecTrk->theta())*(ptrRecTrk->z0()+ptrRecTrk->vz()-zVtx[0]))<1.0 && fabs(ptrRecTrk->d0())<1.0) trkQual = 1;
		else trkQual = 0;
		...
		trkZ0[nTrk] = sin(ptrRecTrk->theta())*(ptrRecTrk->z0()+ptrRecTrk->vz()-zVtx[0]);
		trkD0[nTrk] = ptrRecTrk->d0();

...
algseq += CfgMgr.AnaCumuAlg()                                 #adds an instance of your alg to it
...
#xaodStream.AddAcceptAlgs( "AnaCumuAlg" ) #will only keep events where 'setFilterPassed(false)' has NOT been called in the given algorithm

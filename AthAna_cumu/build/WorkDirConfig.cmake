...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.2.6)" )
endif()
...
set( WorkDir_BASE_PROJECTS AthAnalysis;21.2.6 )
...
set( WorkDir_PACKAGE_NAMES AnaCumu )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES AnaCumuPkg;AnaCumuPkgPrivate;AnaCumuLib;AnaCumu )

prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.ND.171028.pico \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.HMT120.171028.pico \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.HMT160.171028.pico \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore
...
prun \
    ...
    --outDS=user.mizhou.mc15_Pythia8.HMT200.171028.pico \
    --outputs=myaod.root \
		--mergeOutput \
    --useRootCore

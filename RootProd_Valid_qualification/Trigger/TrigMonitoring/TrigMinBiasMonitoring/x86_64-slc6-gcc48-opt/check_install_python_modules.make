...
#cmt_local_tagfile_check_install_python_modules = $(TrigMinBiasMonitoring_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(TrigMinBiasMonitoring_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)TrigMinBiasMonitoring_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)TrigMinBiasMonitoringsetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.1.4/AtlasCore/20.1.4/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/afs/cern.ch/work/m/mizhou/QF1/InstallArea/python/TrigMinBiasMonitoring -level=

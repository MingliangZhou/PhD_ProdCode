...
#cmt_local_tagfile_check_install_joboptions = $(TrigMinBiasMonitoring_tag)_check_install_joboptions.make
...
#cmt_local_tagfile_check_install_joboptions = $(TrigMinBiasMonitoring_tag).make
...
#cmt_final_setup_check_install_joboptions = $(bin)TrigMinBiasMonitoring_check_install_joboptionssetup.make
...
#cmt_final_setup_check_install_joboptions = $(bin)TrigMinBiasMonitoringsetup.make
cmt_local_check_install_joboptions_makefile = $(bin)check_install_joboptions.make
...
$(check_install_joboptionsactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.1.4/AtlasCore/20.1.4/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share *.py ' -installdir=/afs/cern.ch/work/m/mizhou/QF1/InstallArea/jobOptions/TrigMinBiasMonitoring -level=

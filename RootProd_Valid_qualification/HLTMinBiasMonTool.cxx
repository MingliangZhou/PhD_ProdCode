...
//+ + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + 
// + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + 
	addMonGroup(new MonGroup(this, "HLT/MinBiasMon/Track", run, ATTRIB_UNMANAGED));
	addHistogram(new TH1F("hTrkDis", "Tracks Distribution;tracks;entry rate", 200, 0, 200));

	addMonGroup(new MonGroup(this, "HLT/MinBiasMon/L1TE", run, ATTRIB_UNMANAGED));
	addHistogram(new TH1F("hL1teDis", "L1_TE Distribution;L1_TE;entry rate", 70, 0, 70));
	addHistogram(new TH1F("hL1teDisCut0", "nTrk with L1_TE_Cut = 0;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut1", "nTrk with L1_TE_Cut = 5;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut2", "nTrk with L1_TE_Cut = 10;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut3", "nTrk with L1_TE_Cut = 15;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut4", "nTrk with L1_TE_Cut = 20;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut5", "nTrk with L1_TE_Cut = 25;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut6", "nTrk with L1_TE_Cut = 30;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut7", "nTrk with L1_TE_Cut = 40;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut8", "nTrk with L1_TE_Cut = 50;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hL1teDisCut9", "nTrk with L1_TE_Cut = 60;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH2F("hL1teNtrk", "L1_TE & nTrk Correlation;L1_TE;nTrk", 70, 0, 70, 200, 0, 200));

	addMonGroup(new MonGroup(this, "HLT/MinBiasMon/SumEt", run, ATTRIB_UNMANAGED));
	addHistogram(new TH1F("hSumEt", "SumEt Distribution;SumEt;entry rate", 1000, 0, 1000));

	addMonGroup(new MonGroup(this, "HLT/MinBiasMon/SpacePoint", run, ATTRIB_UNMANAGED));
	addHistogram(new TH1F("hSpDis", "Space Points Distribution;space points;entry rate", 600, 0, 3000));
	addHistogram(new TH1F("hSpDisCut0", "nTrk with spCut = 0;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut1", "nTrk with spCut = 200;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut2", "nTrk with spCut = 400;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut3", "nTrk with spCut = 600;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut4", "nTrk with spCut = 800;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut5", "nTrk with spCut = 1000;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut6", "nTrk with spCut = 1200;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut7", "nTrk with spCut = 1400;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut8", "nTrk with spCut = 1600;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hSpDisCut9", "nTrk with spCut = 1800;nTrk;entry rate", 200, 0, 200));

	addMonGroup(new MonGroup(this, "HLT/MinBiasMon/Vtx", run, ATTRIB_UNMANAGED));
	addHistogram(new TH1F("hVtx", "nVtx Distribution;nVtx;entry rate", 10, 0, 10));
	addHistogram(new TH1F("hVtx2Sp", "SP Distribution with vtx=2;nSp;entry rate", 600, 0, 3000));
	addHistogram(new TH1F("hVtxSp", "SP Distribution with vtx=1;nSp;entry rate", 600, 0, 3000));
	addHistogram(new TH1F("hVtxSpCut0", "nTrk with spCut=0 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut1", "nTrk with spCut=50 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut2", "nTrk with spCut=100 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut3", "nTrk with spCut=120 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut4", "nTrk with spCut=140 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut5", "nTrk with spCut=160 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut6", "nTrk with spCut=180 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut7", "nTrk with spCut=200 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut8", "nTrk with spCut=220 at vtx=1;nTrk;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hVtxSpCut9", "nTrk with spCut=240 at vtx=1;nTrk;entry rate", 200, 0, 200));

	addMonGroup(new MonGroup(this, "HLT/MinBiasMon/TrackPriVtx", run, ATTRIB_UNMANAGED));
	addHistogram(new TH1F("hTrkPriDis", "Tracks from PriVtx Distribution;tracks from priVtx;entry rate", 200, 0, 200));
	addHistogram(new TH1F("hTrkPriDisCut0", "nTrk with trkPri = 0;nTrk;entry rate", 200, 0, 200));
...
// + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + 
	...
	for (const auto &i: m_trigItems)	//for each chain
	{
		...
		if (newRun)
		{
			...
			addHistogram(new TH1F("NumGoodOfflineTracks", "Number of accepted offline tracks (trigger passed);tracks;entry rate", 1000, 0, 1000));
		}
 	}
...
// + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + 
//---------------------------------------------
	const xAOD::EnergySumRoI *l1tes = 0;
	CHECK(evtStore()->retrieve(l1tes,"LVL1EnergySumRoI"));
	hist("hL1teDis","HLT/MinBiasMon/L1TE")->Fill(1.*l1tes->energyT()/1000);
//---------------------------------------------
	const xAOD::TrigMissingETContainer *mSumEts = 0;
	CHECK(evtStore()->retrieve(mSumEts,"HLT_xAOD__TrigMissingETContainer_EFMissingET_Fex_2sidednoiseSupp_PUC"));
	for(const auto *mSumEt : *mSumEts)
	{
		hist("hSumEt","HLT/MinBiasMon/SumEt")->Fill(1.*mSumEt->sumEt()/1000);
	}
//---------------------------------------------
	const xAOD::TrackParticleContainer *tracks = 0;
	CHECK(evtStore()->retrieve(tracks,"InDetTrackParticles"));
	float nTrk_offline=0;
	for(const auto *track : *tracks)
	{
		if(track->pt()>400) nTrk_offline++;
	}
	if(nTrk_offline>0) hist("hTrkDis","HLT/MinBiasMon/Track")->Fill(nTrk_offline);
//---------------------------------------------
	const xAOD::TrigSpacePointCountsContainer *spacepoints = 0;
	CHECK(evtStore()->retrieve(spacepoints, "HLT_xAOD__TrigSpacePointCountsContainer_spacepoints"));
	float nSp_online=0;
	for(const auto *spacepoint : *spacepoints)
	{
		nSp_online=(spacepoint->sctSpEndcapA()+spacepoint->sctSpEndcapC()+spacepoint->sctSpBarrel());
	}
	hist("hSpDis","HLT/MinBiasMon/SpacePoint")->Fill(nSp_online);
//---------------------------------------------
	const xAOD::VertexContainer *vtxs = 0;
//	CHECK(evtStore()->retrieve(vtxs,"HLT_xAOD__VertexContainer_xPrimVx"));
	CHECK(evtStore()->retrieve(vtxs,"PrimaryVertices"));
	int mNvtx = 0;
	float trkPri_offline = 0;
	for(const auto *vtx : *vtxs)
	{
		mNvtx++;
		trkPri_offline+=(vtx->nTrackParticles());
	}
	hist("hVtx","HLT/MinBiasMon/Vtx")->Fill(mNvtx);
	if(mNvtx==1)
	{
		hist("hVtxSp","HLT/MinBiasMon/Vtx")->Fill(nSp_online);
		if(nSp_online>=0) hist("hVtxSpCut0","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=50) hist("hVtxSpCut1","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=100) hist("hVtxSpCut2","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=120) hist("hVtxSpCut3","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=140) hist("hVtxSpCut4","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=160) hist("hVtxSpCut5","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=180) hist("hVtxSpCut6","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=200) hist("hVtxSpCut7","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=220) hist("hVtxSpCut8","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
		if(nSp_online>=240) hist("hVtxSpCut9","HLT/MinBiasMon/Vtx")->Fill(nTrk_offline);
	}
	else hist("hVtx2Sp","HLT/MinBiasMon/Vtx")->Fill(nSp_online);
	hist("hTrkPriDis","HLT/MinBiasMon/TrackPriVtx")->Fill(trkPri_offline);
/*//---------------------------------------------
	const xAOD::TrigVertexCountsContainer *vtxs = 0;
	CHECK(evtStore()->retrieve(vtxs,"HLT_xAOD__TrigVertexCountsContainer_vertexcounts"));
	int mNvtx = 0;
	for(const auto *vtx : *vtxs)
	{
		mNvtx = (vtx->vtxNtrks()).size();
	}
	hist("hVtx","HLT/MinBiasMon/Vtx")->Fill(mNvtx);
	if(mNvtx==1)
	{
...
*///---------------------------------------------
	if(nSp_online>0) hist("hSpDisCut0","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>200) hist("hSpDisCut1","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>400) hist("hSpDisCut2","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>600) hist("hSpDisCut3","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>800) hist("hSpDisCut4","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>1000) hist("hSpDisCut5","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>1200) hist("hSpDisCut6","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>1400) hist("hSpDisCut7","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>1600) hist("hSpDisCut8","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
	if(nSp_online>1800) hist("hSpDisCut9","HLT/MinBiasMon/SpacePoint")->Fill(nTrk_offline);
//---------------------------------------------
	if(1.*l1tes->energyT()/1000>0) hist("hL1teDisCut0","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>5) hist("hL1teDisCut1","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>10) hist("hL1teDisCut2","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>15) hist("hL1teDisCut3","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>20) hist("hL1teDisCut4","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>25) hist("hL1teDisCut5","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>30) hist("hL1teDisCut6","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>40) hist("hL1teDisCut7","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>50) hist("hL1teDisCut8","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);
	if(1.*l1tes->energyT()/1000>60) hist("hL1teDisCut9","HLT/MinBiasMon/L1TE")->Fill(nTrk_offline);

	hist2("hL1teNtrk","HLT/MinBiasMon/L1TE")->Fill(l1tes->energyT()/1000.,nTrk_offline,1);
//---------------------------------------------

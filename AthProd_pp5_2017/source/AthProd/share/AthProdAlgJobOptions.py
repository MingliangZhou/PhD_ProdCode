...
jps.AthenaCommonFlags.FilesInput = ["/afs/cern.ch/work/m/mizhou/INPUT_test/data17_pp5_MinBias_f911.root"]   #insert your list of input files here (do this before next lines)
...
algseq += CfgMgr.AthProdAlg()                                 #adds an instance of your alg to it

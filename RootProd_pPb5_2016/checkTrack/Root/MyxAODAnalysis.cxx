...
EL::StatusCode MyxAODAnalysis :: initialize ()
{
	...
	tree = new TTree("tree","2016 pPb 5 TeV");
	...
	tree->Branch("mPhi",     mPhi,      "mPhi[nTrk]/F");
...
EL::StatusCode MyxAODAnalysis :: execute ()
{
	...
	if(1)
	{
		for(int i=0; i<13; i++)
		{
			...
			if(i==1)  sprintf(name,"HLT_mb_sp100_trk10_hmt_L1MBTS_1_1");
			if(i==2)  sprintf(name,"HLT_mb_sp100_trk20_hmt_L1MBTS_1_1");
			if(i==3)  sprintf(name,"HLT_mb_sp100_trk30_hmt_L1MBTS_1_1");
			if(i==4)  sprintf(name,"HLT_mb_sp100_trk40_hmt_L1MBTS_1_1");
			if(i==5)  sprintf(name,"HLT_mb_sp100_trk50_hmt_L1MBTS_1_1");
			if(i==6)  sprintf(name,"HLT_mb_sp100_trk60_hmt_L1MBTS_1_1");
			if(i==7)  sprintf(name,"HLT_mb_sp100_trk70_hmt_L1MBTS_1_1");
			if(i==8)  sprintf(name,"HLT_mb_sp100_trk80_hmt_L1MBTS_1_1");
			if(i==9)  sprintf(name,"HLT_mb_sp100_trk90_hmt_L1MBTS_1_1");
			if(i==10) sprintf(name,"HLT_mb_sp100_trk100_hmt_L1MBTS_1_1");
			if(i==11) sprintf(name,"HLT_mb_sp100_trk110_hmt_L1MBTS_1_1");
			if(i==12) sprintf(name,"HLT_mb_mbts_L1MBTS_1");

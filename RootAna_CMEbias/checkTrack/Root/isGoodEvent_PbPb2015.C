...
int isGoodEvent_PbPb2015(int run, int lb, int bcid=1)
{
	switch(run)
	{
		...
		case 287843:	if(lb>=126 && lb<=525)
									{
										return isGoodBCID_492(bcid);
									}
									else  return 0;

		case 287827:	if(lb>=51 && lb<=458)
									{
										return isGoodBCID_492(bcid);
									}
									else  return 0;

		case 287728:	if(lb>=175 && lb<=585)
									{
										return isGoodBCID_492(bcid);
									}
									else  return 0;
		...
		case 287594:	if(lb>=38 && lb<=326)
									{
										return isGoodBCID_424(bcid);
									}
									else  return 0;

		case 287560:	if(lb>=245 && lb<=355)
									{
										return isGoodBCID_32(bcid);
									}
									else  return 0;

		case 287382:	if(lb>=135 && lb<=477)
									{
										return isGoodBCID_424(bcid);
									}
									else  return 0;

		case 287380:	if(lb>=120 && lb<=124)
									{
										return isGoodBCID_424(bcid);
									}
									else  return 0;

		case 287378:	if(lb>=101 && lb<=432)
									{
										return isGoodBCID_424(bcid);
									}
									else  return 0;

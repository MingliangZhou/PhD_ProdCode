...
OUTDIR=${DESTDIR}/usr/WorkDir/21.2.15/InstallArea/x86_64-slc6-gcc62-opt
...
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.8.1/Linux-x86_64/bin/cmake -E copy /afs/cern.ch/work/m/mizhou/AthProd_XeXe5_2017/build/x86_64-slc6-gcc62-opt/bin/*.dbg \
    ${OUTDIR}/bin/
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.8.1/Linux-x86_64/bin/cmake -E copy /afs/cern.ch/work/m/mizhou/AthProd_XeXe5_2017/build/x86_64-slc6-gcc62-opt/lib/*.dbg \
    ${OUTDIR}/lib/
